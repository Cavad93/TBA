...
биометрия, только транскрипция в текст. Сервис слушает ТОЛЬКО приватный wg-адрес
(10.8.0.2:5100): снаружи недоступен, сервер 1 ходит сюда шифрованным каналом WireGuard
(подсеть 10.8.0.0/24). Доступ — по Bearer-токену.
"""
