...
def _normalize_address_text(input_text: str) -> str:
    ...
    replacements = {
        ...
        # Частая опечатка: «Коменданский» без «т». Nominatim её не прощает, а с
        # исправлением адрес находится однозначно (в отличие от DaData, которая на
        # опечатке предлагает ещё и Коломяжский).
        r"\bкоменданск(ий|ого|ому|им|ом)\b": r"комендантск\1",
        r"\bпр-т\b": "проспект",
        r"\bпр\.\b": "проспект",
        r"\bш\.\b": "шоссе",
        r"\bул\.\b": "улица",
