...
def finalize_day(
    ...
    service_minutes_total = total_work_minutes - route_minutes - data.telemed_minutes
    if service_minutes_total < 0:
        raise ValueError("Время дороги и телемедицины больше общего рабочего времени.")
    service_per_visit = (
