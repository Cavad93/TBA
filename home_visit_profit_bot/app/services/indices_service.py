...
# Насколько сильно эти факторы двигают индекс. На краю шкалы дают ±18
# ((100−50)×0.36): заметно, но не перебивает короткий перерыв и ночные часы,
# которые остаются главными.
