...
RECOVERY_EXTRA_WEIGHTS: dict[str, float] = {
    ...
    "drinks_units": 0.05,
    "meal_units": 0.05,
    # Походка — 20% в сумме. Сигнал более прямой, чем количество кофе: между телом и
    # датчиком не стоит ничего, в отличие от вождения, где стоит машина. Основной вес
    # у разброса шага: замедлиться можно и просто задумавшись, а вот «плавать» шагом
    # отдохнувший человек не начинает.
    "walk_step_cv": 0.10,
    "walk_cadence": 0.06,
    "walk_regularity": 0.04,
}
